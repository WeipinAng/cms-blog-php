    ...
    <?php include "includes/admin_navigation.php"; ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h4 mb-4 text-gray-800">Comments of a Post</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">All Comments from a Post</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover w-auto small" id="dataTable" width="100%" cellspacing="0">
                ...
                while ($row = mysqli_fetch_assoc($select_comments)) {
                    ...
                    echo "<td><a href='comments_of_a_post.php?approve=$comment_id&post_id=$post_id'>Approve</a>
                    </br></br>
                              <a href='comments_of_a_post.php?unapprove=$comment_id&post_id=$post_id'>Unapprove</a></td>";
                    echo "<td><a href='comments_of_a_post.php?delete=$comment_id&post_id=$post_id' onClick=\"javascript: return confirm('Are you sure you want to delete this comment by $comment_author?')\">Delete</a></td>";
                    echo "</tr>";
                }
                ...
                if(isset($_GET['approve'])) {
                    ...
                    header("Location: comments_of_a_post.php?post_id=$post_id");
                }
